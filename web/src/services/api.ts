...
export const api = {
  ...
  aiBacktest: (symbol: string, spec: StrategySpec, initialCash: number) => request<BacktestResult>('/api/ai/strategy/backtest', { method: 'POST', body: JSON.stringify({ symbol, spec, initial_cash: initialCash }) }),
